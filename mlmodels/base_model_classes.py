...
class DataFrameModel:
    ...
    def get_open_api_yaml(self):
        return open_api_yaml_specification(
            model_input_record_field_schema_dict=self.get_model_record_field_schemas()['features'],
            possible_categorical_column_values=(self.possible_categorical_column_values or {}),
            model_target_field_schema_dict=self.get_model_record_field_schemas()['targets']
        )
